...
Deno.test("test each((node, index) => void)", function () {
  const data = [
    {
      title: "财务",
...
Deno.test("test each((node, index, parents) => void)", function () {
  const data = [
    {
      title: "财务",
      items: [{ title: "收入流失" }, { title: "财务设置" }],
...
Deno.test('test each(childrenKey="items")', function () {
  const data = [
    {
      title: "财务",
      items: [{ title: "收入流失" }, { title: "财务设置" }],
...
Deno.test("test each((node) => true)", function () {
  const data = [
    {
      title: "财务",
      items: [{ title: "收入流失" }, { title: "财务设置" }],
